...
namespace UWP_APP_v1.Pages
{
    ...
    /// </summary>
    public sealed partial class NaViewPage : Page
    {
        public NaViewPage()
        {
        ...
        public void ContentFrame_NavigationFailed(object sender, NavigationFailedEventArgs e)
        {
            throw new Exception("Failed to load Page" + e.SourcePageType.FullName);
        }

        public readonly List<(string Tag, Type Page)> _pages = new List<(string Tag, Type Page)>
        {
        ...
        {           
            ...
            NavView_Navigate("songlist", new EntranceNavigationTransitionInfo());
        ...
        public void BackInvoked(KeyboardAccelerator sender, KeyboardAcceleratorInvokedEventArgs args)
        {
            On_BackRequested();
            args.Handled = true;
        }
